...
reset_runtime_env() {
  ...
  unset LOGIT_MARGIN
  unset LOGIT_MARGIN_LOSS_WEIGHT
...
export LOGIT_MARGIN="${LOGIT_MARGIN:-0.05}"
export LOGIT_MARGIN_LOSS_WEIGHT="${LOGIT_MARGIN_LOSS_WEIGHT:-0.4}"
...
echo "LOGIT_MARGIN=$LOGIT_MARGIN"
echo "LOGIT_MARGIN_LOSS_WEIGHT=$LOGIT_MARGIN_LOSS_WEIGHT"
"$PYTHON" train_gpt.py
}
